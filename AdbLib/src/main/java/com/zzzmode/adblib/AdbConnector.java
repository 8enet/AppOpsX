...
public final class AdbConnector {
    ...
    public static AdbConnection connection(Context context, String host, int port) throws Exception {
        ...
        AdbCrypto crypto = setupCrypto(path + File.separatorChar + "pub.key", path + File.separatorChar + "priv.key");
    ...
    public static AdbConnection buildConnect(Context context, String host, int port) throws Exception {
