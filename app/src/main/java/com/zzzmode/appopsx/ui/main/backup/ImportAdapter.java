...
class ImportAdapter extends RecyclerView.Adapter<ImportAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImportAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_import_layout, parent, false));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(RestoreModel model){
            ...
            tvFileSize.setText(tvFileSize.getResources().getString(R.string.backup_file_size,Formatter.formatFileSize(model.fileSize)));
        }
    }
