...
class PersistenceConfig {
    ...
    PersistenceConfig() {
        ...
        String sql = "create table if not exists " + TABLE_NAME + " ( uid integer primary key ,block_ops text);";
        database.execSQL(sql);

        sqLiteStatement = database.compileStatement("update  OR REPLACE TABLE_NAME set block_ops =? where uid =?");
        load();
